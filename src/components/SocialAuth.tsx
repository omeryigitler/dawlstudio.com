  ...
  return (
    <div className="space-y-4 mt-8">
      <div className="relative flex items-center justify-center">
        ...
        <span className="relative px-4 bg-charcoal text-[10px] uppercase tracking-[0.2em] text-limestone/40">
          Or continue with
        </span>
      </div>

      <div className={`grid gap-4 ${isGoogleEnabled ? "grid-cols-2" : "grid-cols-1"}`}>
        {isGoogleEnabled && (
          <button
